...
struct my_async_server_base : server_storage_base, socket_options_base {
  ...
  explicit my_async_server_base(server_options<Tag, Handler> const &options)
...
struct my_server : my_async_server_base<tags::http_server, Handler> {
  /// A convenience typedef for the base of this type, implementing most of
  /// the internal details.
  typedef my_async_server_base<tags::http_server, Handler> server_base;
