...
public class ICEAdapterTest {
	...
	public static final String GDPR = "By using this application you consent to it collecting your username and IP address(es) during the test." +
			...
			"All collected data will be deleted immediately after investigation." +
			"To get information about the stored data or to request deletion please contact geosearchef@geosearchef.de.";
}